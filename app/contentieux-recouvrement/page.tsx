...
export default function ContentieuxRecouvrement() {
  const timelineSteps = [
    {
      title: "Le diagnostic de la situation",
      description:
        "Analyse du dossier, évaluation de la maturité et de l’intensité du litige, définition de la stratégie à adopter (amiable, contentieux…)",
      position: "left",
      step: 1,
    },
    {
      title: "L’exploitation de l’amiable et du pré-contentieux",
      description:
        "Négociations confidentielles, mise en demeure, médiation, conciliation, rédaction d’accords transactionnels",
      position: "right",
      step: 2,
    },
    {
      title: "La conduite de la procédure judiciaire",
      description:
        "Représentation devant les juridictions civiles et commerciales, rédaction des actes de procédure (assignation, conclusions…), plaidoiries",
      position: "left",
      step: 3,
    },
    {
      ...
      description:
        "Suivi de la signification des décisions de justice, mesures conservatoires, mesures d’exécution",
      position: "right",
      step: 4,
    },
  ];
  ...
  const phases = [
    {
      ...
      items: [
        "Contentieux contractuel, rupture abusive des relations commerciales, de franchise, de distribution",
        "Responsabilité, clauses abusives",
        "Concurrence déloyale, parasitisme",
      ],
      icon: FileText,
    },
    {
      title: "Contentieux des sociétés",
      items: [
  ...
  const advantages = [
    {
      icon: Handshake,
      title: "Une stratégie adaptée à vos besoins",
      description:
        "Pas de procédure inutile, nous privilégions l’amiable et calibrons les actions à mener en fonction de l’enjeu du litige",
    },
    {
      icon: FileText,
      title: "La maîtrise de la procédure",
      description:
        "Expertise technique en procédure civile et voies d’exécution, rédaction d’actes de procédure claire et persuasive, plaidoiries percutantes",
    },
    {
      icon: Clock,
      title: "Communication et transparence",
      description:
        "Procédure au forfait ou devis détaillé, suivi régulier, communication et mise à jour en cas d’évolution du litige",
    },
  ];
      ...
      >
        <div className="max-w-7xl justify-center flex flex-col mx-auto w-full relative z-10">
          ...
          >
            ...
            >
              La bonne gestion d’un litige s’apprécie au regard des enjeux
              économiques et de l’impact sur l’activité de votre entreprise, en
              interne et auprès de vos partenaires.
              <br />
              <br />
              Ils conditionnent la stratégie et les moyens à mettre en œuvre
              pour résoudre les conflits et préserver au mieux vos intérêts.
            </motion.p>
            <div>
              <Link
                href="/contact"
        ...
        <div className="max-w-7xl mx-auto relative">
          ...
          >
            <h2 className="text-3xl md:text-4xl font-bold mb-6 bg-clip-text text-transparent bg-gradient-to-r from-white via-accent to-white bg-[length:200%_auto] hover:bg-[length:200%_auto] transition-all duration-700 ease-in-out hover:bg-[position:100%_0] bg-[position:0_0]">
              ADWIZ vous représente devant les juridictions civiles et
              commerciales
            </h2>
          </motion.div>
