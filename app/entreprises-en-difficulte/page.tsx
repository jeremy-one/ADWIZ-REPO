...
export default function DroitDesSocietesDroitDesContrats() {
  const timelineSteps = [
    {
      title: "Diagnostiquer la situation",
      description:
        "Identification des difficultés, niveau d’alerte, analyse des leviers économiques et juridiques",
      position: "left",
      step: 1,
    },
    {
      title: "Choisir le cadre adapté",
      description:
        "Négociations de gré à gré, prévention (mandat ad hoc, conciliation), protection judiciaire (sauvegarde, redressement judiciaire, liquidation judiciaire)",
      position: "right",
      step: 2,
    },
    {
    ...
    {
      title: "Sécuriser le traitement des difficultés",
      description:
        "Préparation des étapes, des actes et des formalités dans les délais stricts imposés par la procédure",
      position: "right",
      step: 4,
    },
  ];
  ...
  const phases = [
    {
      title: "Traiter les difficultés de votre entreprise",
      items: [
        "Prévention (mandat ad hoc, conciliation), négociations, rédaction des accords",
        "Procédures judiciaires (sauvegarde, redressement judiciaire, liquidation judiciaire)",
        "Rédaction des actes, élaboration des plans",
        "Responsabilité des dirigeants",
      ],
      icon: FileText,
    },
    {
      title: "Protéger vos intérêts de créancier",
      items: [
        "Actions préventives, négociations, évaluation des perspectives de recouvrement",
        "Assignation en redressement ou liquidation judiciaire",
        "Déclarations de créances, contrats en cours, revendications, restitutions",
        "Suivi de la procédure : plan, cession, liquidation",
      ],
      icon: CheckCircle,
    },
  ];
  ...
  const advantages = [
    {
      icon: Handshake,
      title: "Un soutien face à la difficulté",
      description:
        "Vous êtes déchargé du poids de la procédure et vous vous concentrez sur le redressement de votre activité",
    },
    {
      icon: FileText,
      title: "La maîtrise de la procédure",
      description:
        "Un interlocuteur crédible face aux organes de la procédure et vos partenaires (banques, clients, fournisseurs…)",
    },
    {
      icon: Clock,
      title: "Un accompagnement transparent",
      description:
        "Mission encadrée par un forfait ou un devis par phase, selon la situation",
    },
  ];
      ...
      >
        <div className="max-w-7xl justify-center flex flex-col mx-auto w-full relative z-10">
          ...
          >
            ...
            >
              Traiter les difficultés de l’entreprise avec ADWIZ Avocat en
            ...
            >
              Qu’il s’agisse de votre entreprise ou de l’un de vos partenaires
              commerciaux, les difficultés rencontrées par une société doivent
              être traitées avec attention.
              <br />
              <br />
              L’anticipation est le meilleur moyen de préserver vos intérêts et
              faire des procédures collectives un instrument de rebond.
            </motion.p>
            <div>
              <Link
                href="/contact"
        ...
        <div className="max-w-7xl mx-auto relative">
          ...
          >
            <h2 className="text-3xl md:text-4xl font-bold mb-6 bg-clip-text text-transparent bg-gradient-to-r from-white via-accent to-white bg-[length:200%_auto] hover:bg-[length:200%_auto] transition-all duration-700 ease-in-out hover:bg-[position:100%_0] bg-[position:0_0]">
              ADWIZ vous apporte son expertise en procédures collectives pour
            </h2>
          </motion.div>
